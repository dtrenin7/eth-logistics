...
module.exports = function(app) {
  ...
  app.use('/api/get_balance', require('./api/get_balance'));
  app.use('/api/eth2cc', require('./api/eth2cc'));
  app.use('/api/cc2eth', require('./api/cc2eth'));
  app.use('/api/get_orders', require('./api/get_orders'));
