...
exports.index = async function(req, res) {
  ...
  try {
   ...
   var cc = await contract.at(settings.cargoCoinAddress);
    ...
    await makePromise2(web3.personal.unlockAccount, [input.account, input.password]);
    var microCC = toMicroCC(input.cc).toString();
    var transactionHash = await makePromise2(cc.cc2ether, [microCC, {from:input.account, to:settings.cargoCoinAddress, gasLimit:210000, gasPrice:20000000000}]);
