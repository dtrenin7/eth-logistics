...
exports.index = async function(req, res) {
  ...
  try {
   ...
   var cc = await contract.at(settings.cargoCoinAddress);
    ...
    var weis = web3.toWei(input.eth);
    var transactionHash = await makePromise2(cc.ether2cc, [{from:input.account, to:settings.cargoCoinAddress, value:weis, gasLimit:210000, gasPrice:20000000000}]);
